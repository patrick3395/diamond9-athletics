              ...
              <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required placeholder="Your name" className="w-full bg-zinc-900/50 border border-zinc-800 focus:border-amber-500/40 text-white text-sm px-4 py-3 rounded-xl outline-none transition-all placeholder:text-zinc-700" />
                  </div>
                  <div>
                    <label className="block text-zinc-500 text-xs tracking-wider mb-1.5">EMAIL</label>
                    <input type="email" required placeholder="your@email.com" className="w-full bg-zinc-900/50 border border-zinc-800 focus:border-amber-500/40 text-white text-sm px-4 py-3 rounded-xl outline-none transition-all placeholder:text-zinc-700" />
                  </div>
                </div>
                <div>
                  <label className="block text-zinc-500 text-xs tracking-wider mb-1.5">PHONE</label>
                  <input type="tel" placeholder="(555) 000-0000" className="w-full bg-zinc-900/50 border border-zinc-800 focus:border-amber-500/40 text-white text-sm px-4 py-3 rounded-xl outline-none transition-all placeholder:text-zinc-700" />
                </div>
                <div>
                  <label className="block text-zinc-500 text-xs tracking-wider mb-1.5">PLAN INTEREST</label>
                  <select className="w-full bg-zinc-900/50 border border-zinc-800 focus:border-amber-500/40 text-white text-sm px-4 py-3 rounded-xl outline-none transition-all">
                ...
                <div>
                  ...
                  <textarea rows={4} placeholder="Tell us about your goals..." className="w-full bg-zinc-900/50 border border-zinc-800 focus:border-amber-500/40 text-white text-sm px-4 py-3 rounded-xl outline-none transition-all placeholder:text-zinc-700 resize-none" />
                </div>
